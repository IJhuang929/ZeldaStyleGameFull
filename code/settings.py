...
# enemy (resistance = push back distance)
"""health= blood, exp= experience, damage= player hurt, attack_type= for its attack way, speed= its move speed, resistance= push back distance,
attack_radius= the distance for monster can attack, notice_radius= the distance for monster move toward the player and not attack  """
